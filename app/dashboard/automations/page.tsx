      ...
      <div className="flex items-center justify-center min-h-screen">
        <Card className="w-96">
          <CardHeader>
            ...
            <CardDescription>Unable to load automations</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Automation workflows are currently in development
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                <Zap className="h-12 w-12 mx-auto mb-4 opacity-50" />
                <p>Create automated workflows for lead scoring, follow-ups, and more</p>
